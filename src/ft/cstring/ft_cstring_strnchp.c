...
/*   Updated: 2022/09/12 13:42:04 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ft_strnchp(const char *str, size_t max_len, char ch)
{
	...
	if (!str)
	{
		ft_io_puts(STDERR_FILENO, "ft_strnchp(): wrong parameter given\n");
...
size_t	ft_strnrchp(const char *str, size_t max_len, char ch)
{
	...
	if (!str)
	{
		ft_io_puts(STDERR_FILENO, "ft_strnrchp(): wrong parameter given\n");
		ft_exit(EXIT_FAILURE);
		return (0);
	}
	i = -1;
